...
test_v2_release_contract_is_consistent() {
  ...
  assert_contains "$plugin" '"version": "2.0.2"'
  assert_contains "$manifest" 'release 2.0.2'
  assert_contains "$launcher" 'CLIENT_RELEASE="2.0.2"'
  assert_contains "$skill" '--client-release 2.0.2'
  assert_contains "$maintenance" 'agent-comms--v2.0.2'
